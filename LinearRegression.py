...
class LinearRegression:
    ...
    def initialize_parameters(self):
        ...
        self.theta_1 = self.theta_1.reshape(1, 1)
        self.theta_0 = 0
    ...
    def fit(self, X, y, stopping_condition="cost_based"):
        ...
        if stopping_condition == "l2_norm_based":
            while (E1 is None and E0 is None) or math.sqrt((E1 * E1) + (E0 * E0)) > 0.0000001:
        ...
        if stopping_condition == "cost_based":
            old_error = None
            error = None
            while (old_error is None or error is None) or abs(old_error-error) > 0.0000001:
